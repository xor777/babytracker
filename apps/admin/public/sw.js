...
/* v3 — смена оформления. Версию обязательно двигать вместе с оболочкой:
   старый кэш отдаёт старые CSS и JS, и на телефоне, где приложение уже
   стоит, новый вид просто не появится. На разработке это стоило получаса:
   исходники менялись, а экран оставался прежним. */
const VERSION = 'v3';
