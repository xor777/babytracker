    ...
    <>
      ...
      <div className="stats-grid">
        ...
        <section className="card card--wide" style={{ '--tone': 'var(--t-measure)' } as CSSProperties}>
          ...
          {/* График сразу под числом, до разборов.

              Он стоял после четырёх строк фактов, и на экране 844 px его
              верх приходился на 885-й — то есть за сгибом. «Как он растёт»
              — это первое, зачем сюда заходят, и ради ответа на него не
              должно быть ни одного движения пальцем.

              Рисуется всегда, даже когда сводки по весу нет: точки могут
              быть и тогда, когда посчитать по ним нечего. */}
              ...
              <table className="wtable">
                <thead>
                  <tr>
                    ...
                    {/* Мягкий перенос (U+00AD) — единственное, что даёт браузеру
                        право сузить колонку. Без него «кормлений» неразрывно
                        держит девяносто пикселей ради заголовка, под которым
                        стоит «7,4», и таблица уезжает за край. Виден дефис
                        только тогда, когда перенос действительно случился. */}
                    <th scope="col">{'корм\u00ADлений'}</th>
                    <th scope="col">{'мок\u00ADрых'}</th>
                    <th scope="col">{'гряз\u00ADных'}</th>
                    <th scope="col">сна</th>
                  </tr>
                </thead>
                <tbody>
