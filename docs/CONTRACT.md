...
Гонять Opus на каждое уверенно распознанное «заснул» всё равно не стоит — это тратит окно
лимита на уже разобранное и даёт модели повод «исправить» то, что не сломано.
...
| `all`    | на каждую фразу — максимальное качество, окно лимита расходуется быстрее |
